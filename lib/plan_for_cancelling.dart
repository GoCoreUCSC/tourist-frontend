...
class CancelPlans extends StatefulWidget {
  String name, token;
  CancelPlans(this.name, this.token);
  //const BookingPlans({Key? key}) : super(key: key);

  @override
  State<CancelPlans> createState() 
  {
    return _CancelPlans(this.name,this.token);
  }
 
}

class _CancelPlans extends State<CancelPlans> {
  String name, token;
  _CancelPlans(this.name, this.token);
