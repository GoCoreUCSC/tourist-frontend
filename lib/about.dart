          ...
          children: [
                    ...
                    child: DropdownButtonFormField(
                      decoration: InputDecoration(
                        ...
                        enabledBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: Color(0xFF1554F6), width: 2),
                      ...
                      // ),
                      items:
                          Destinations.map((item) => DropdownMenuItem<String>(
                                value: item,
                                child: Text(
                                  item,
            ...
            Padding(
              ...
              child: DropdownButtonFormField(
                ...
                //   borderRadius: BorderRadius.circular(15),
                // ),
                items: Hotels.map((item) => DropdownMenuItem<String>(
                      value: item,
                      child: Text(
                        item,
                        style: const TextStyle(
