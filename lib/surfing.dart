...
class Surfing extends  StatefulWidget {
  String name, token;
  Surfing(this.name, this.token);
  @override
  State<Surfing> createState() {
     return _SurfingState(this.name,this.token);
...
class _SurfingState extends State<Surfing> {
   String name, token;
   _SurfingState(this.name,this.token);
  ...
  getData() async { 
      ...
      String url = "https://gocore.herokuapp.com/getactivities4";
        ...
        //   padding: const EdgeInsets.all(10),
          child: Column(
            children: [
               Positioned(
              top: 0,
              child: Image.asset('images/surfing.jpg',fit: BoxFit.fill,height: 210, width:455,)),
              const SizedBox(
                height: 20,
              ),
              Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        ...
                        labelText: 'Search your surfing destinations.....', suffixIcon: Icon(Icons.search)),
                  ),
