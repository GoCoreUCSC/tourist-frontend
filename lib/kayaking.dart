...
class Kayaking extends  StatefulWidget {
  String name, token;
  Kayaking(this.name, this.token);
  @override
  State<Kayaking> createState() {
     return _KayakingState(this.name,this.token);
...
class _KayakingState extends State<Kayaking> {
  String name, token;
   _KayakingState(this.name,this.token);
  ...
  getData() async { 
      ...
      String url = "https://gocore.herokuapp.com/getactivities3";
        ...
        //   padding: const EdgeInsets.all(10),
          child: Column(
            children: [
               Positioned(
              top: 0,
              child: Image.asset('images/kayaking.jpg',fit: BoxFit.fill,height: 210, width:455,)),
              const SizedBox(
                height: 20,
              ),
              Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        ...
                        labelText: 'Search your kayaking destinations.....', suffixIcon: Icon(Icons.search)),
                  ),
