...
class Hiking extends  StatefulWidget {
  String name, token;
  Hiking(this.name, this.token);
  @override
  State<Hiking> createState() {
     return _HikingState(this.name,this.token);
...
class _HikingState extends State<Hiking> {
  String name, token;
   _HikingState(this.name,this.token);
  ...
  getData() async { 
      ...
      String url = "https://gocore.herokuapp.com/getactivities1";
        ...
        //   padding: const EdgeInsets.all(10),
          child: Column(
            children: [
               Positioned(
              top: 0,
              child: Image.asset('images/hike.jpg',fit: BoxFit.fill,height: 210, width:455,)),
              const SizedBox(
                height: 20,
              ),
              Padding(
