...
class Tours extends StatefulWidget {
  ...
  HashSet selectItems;
  String name, token;
  Tours(this.valueD, this.valueT, this.valueP, this.selectActivity, this.selectItems, this.startDate, this.endDate ,this.name,this.token,{Key? key}) : super(key: key);

//Tours({Key? key}) : super(key: key);
  @override
  _ToursState createState() 
  {
    return _ToursState(this.valueD, this.valueT, this.valueP, this.selectActivity,this.selectItems,this.startDate, this.endDate ,this.name,this.token);
  }
...
class _ToursState extends State<Tours> {
  ...
  HashSet selectActivity; 
  HashSet selectItems;
  _ToursState(this.valueD,this.valueT,this.valueP,this.selectActivity, this.selectItems, this.startDate, this.endDate,this.name,this.token);
