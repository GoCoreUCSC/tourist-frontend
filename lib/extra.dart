...
class CustomizationExtra extends StatefulWidget {
  CustomizationExtra({Key? key}) : super(key: key);

  @override
  _CustomizationExtraState createState() => _CustomizationExtraState();}

class _CustomizationExtraState extends State<CustomizationExtra> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text("Destination 1", style: TextStyle(color: Colors.black,fontSize: 19)),
            ...
            Container(
              alignment: Alignment.topLeft,
              padding: const EdgeInsets.fromLTRB(20, 10, 90, 0),
              child: Text("Destination 2", style: TextStyle(color: Colors.black,fontSize: 19)),
            ...
            Container(
              alignment: Alignment.topLeft,
              padding: const EdgeInsets.fromLTRB(20, 10, 90, 0),
              child: Text("Destination 3", style: TextStyle(color: Colors.black,fontSize: 19)),
           ...
           Container(
              alignment: Alignment.topLeft,
              padding: const EdgeInsets.fromLTRB(20, 10, 90, 0),
              child: Text("Destination 4", style: TextStyle(color: Colors.black,fontSize: 19)),
